...
//./a.out gnome-calculator gedit f1.txt f2.txt f3.txt

void calculadora(char *ejecutar);
void editor(char *f[]);
...
int main(int argc, char **argv) 
{
    ...
    for(int i=0;i<2;i++)
    {
    	...
    	else if (pid == 0) //hijo
    	{
    		...
    		{
    			editor(argv+2);//Le pasa desde el argumento argv[2] con los siguientes argumentos en un char
    		}
